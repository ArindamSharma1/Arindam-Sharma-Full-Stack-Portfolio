...
export const PROJECTS = [
    ...
    },
    {
        ...
        tech: ['React', 'Shopify', 'RBAC', 'Tailwind', 'Vercel'],
        description:
            'Production-ready e-commerce platform featuring Shopify backend integration and Role-Based Access Control. Built a modern, high-performance React storefront with seamless payment processing.',
        outcome: 'Delivered a scalable, secure shopping experience with optimized checkout flows.',
